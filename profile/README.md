...
We foster a collaborative environment that promotes excellence in neuroscience research and education to provide training that prepares the next generation of neuroscience leaders while advancing the understanding of neurodegenerative diseases through cutting-edge genomics research, data analysis, and computational methods.

## Getting Started

- 🔍 Explore our [repositories](https://github.com/orgs/UPENN-PNGC/repositories)
...
- [Documentation](https://github.com/UPENN-PNGC)
- [Support](../SUPPORT.md)

## Contact

For questions or support, please refer to our [Support Guidelines](../SUPPORT.md).

---

© 2026 University of Pennsylvania - PNGC
